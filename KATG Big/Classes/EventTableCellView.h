...
@interface EventTableCellView : UITableViewCell 
{
	UIImageView *eventTypeImageView;
	UILabel     *eventTitleLabel;
	UILabel     *eventDayLabel;
	UILabel     *eventDateLabel;
	UILabel     *eventTimeLabel;
}

@property (nonatomic, retain) IBOutlet UIImageView *eventTypeImageView;
@property (nonatomic, retain) IBOutlet UILabel     *eventTitleLabel;
@property (nonatomic, retain) IBOutlet UILabel     *eventDayLabel;
